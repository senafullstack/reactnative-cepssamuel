  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(6) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '11427ffec6234dd35c2840f1b89d2efb')");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsUpdates = new HashMap<String, TableInfo.Column>(9);
        ...
        _columnsUpdates.put("manifest", new TableInfo.Column("manifest", "TEXT", false, 0));
        ...
        _columnsUpdates.put("last_accessed", new TableInfo.Column("last_accessed", "INTEGER", true, 0));
    ...
    }, "11427ffec6234dd35c2840f1b89d2efb", "4a4428f24b1a17de152309d8a09b40be");
